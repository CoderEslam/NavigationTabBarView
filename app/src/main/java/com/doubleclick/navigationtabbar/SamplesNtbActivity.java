package com.doubleclick.navigationtabbar;
...
import com.doubleclick.navigationtabbar.ntb.NavigationTabBar;
...
public class SamplesNtbActivity extends Activity {
    ...
    private void initUI() {
        final NavigationTabBar ntbSample1 =  findViewById(R.id.ntb_sample_1);
